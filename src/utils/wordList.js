...
export const WORD_LIST = [
  ...
  'BASES', 'BASIC', 'BEACH', 'BEGAN', 'BEGIN', 'BENCH', 'BILLY', 'BIRTH', 'BLACK', 'BLAME',
  'BLANK', 'BLIND', 'BLOCK', 'BLOOD', 'BOARD', 'BOOST', 'BOOTH', 'BOUND', 'BRAIN', 'BRAND',
  'BRASS', 'BRAVE', 'BREAD', 'BREAK', 'BREED', 'BRIEF', 'BRING', 'BROAD', 'BROKE', 'BROWN',
  'BUILD', 'BUYER', 'CABLE', 'CACHE', 'CARRY', 'CATCH', 'CAUSE', 'CHAIN', 'CHAIR', 'CHAOS',
  ...
  'RANGE', 'RAPID', 'RATIO', 'REACH', 'READY', 'REFER', 'RELAX', 'RIDER', 'RIGHT', 'RIVAL',
